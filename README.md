...
$\bigtriangleup = \begin{pmatrix} 1 & x_0 & x_0^2 & \cdots & x_0^n \\ 1 & x_1 & x_1^2 & \cdots & x_1^n \\ \cdots  & \cdots  & \cdots & \cdots & \cdots  \\ 1 & x_n & x_n^2 & \cdots & x_n^n \\ \end{pmatrix} $
= $\displaystyle\prod_{\substack{
                            i,j = 1 \\
                            i \neq j
                            }} 
                            (x_i - x_j)$
